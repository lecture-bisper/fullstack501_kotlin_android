...
import com.bitc.app1229.databinding.ActivityTouchBinding
...
//          rawX, rawY : 전체화면에서 이벤트가 발생한 x, y 좌표를 출력
          Log.d("csy_view", "Touch move event x : ${event.x}, y : ${event.y}, rawX : ${event.rawX}, rawY : ${event.rawY}")
        }
      }
      true
    }
...
//  터치와 관련된 이벤트 정보를 엑티비티에서 받으려면 onTouchEvent 메소드를 오버라이딩해야 함
