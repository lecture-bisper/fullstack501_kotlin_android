...
// val : 초기값 설정 후 변경할 수 없는 변수, 자바의 읽기 전용은 final 변수와 같음
...
// 함수의 멤버 변수를 제외한 모든 변수는 선언과 동시에 초기값이 설정되어야 함
var data7 = 70
var data8: Int = 80
// 초기값이 설정되지 않아서 오류 발생
//var data9: Int
...
// lateinit은 var 키워드를 사용한 변수에만 사용 가능
// lateinit은 코틀린의 기본 데이터 타입인 Byte, Short, Int, Long, Float, Double, Boolean에는 사용할 수 없음

// by lazy {} 는 val, var 키워드 모두 사용할 수 있음
// by lazy {} 는 모든 데이터 타입에 적용할 수 있음
// by lazy {} 의 코드 블럭 안에서 간단한 연산이 가능함
// by laze {} 의 코드 블럭 가장 마지막에 있는 데이터를 해당 변수의 초기값으로 사용
...
//  var을 사용하여 데이터의 변경이 가능함
  data2 = 200
//  val을 사용하여 데이터의 변경이 불가능함
//  data1 = 100
...
//  코드 블럭 가장 마지막에 있던 데이터가 변수 data18에 대입됨
  println(data18 + 10)
//  변수 data18은 한번 초기화 했으므로 by lazy {} 의 코드 블럭을 실행하지 않음, 기존의 저장된 내용만 사용
  println(data18 + 10)
}
